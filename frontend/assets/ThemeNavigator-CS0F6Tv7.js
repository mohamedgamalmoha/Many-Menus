...
`;function fi(e,s,t){switch(t){case"bottom-left":return s?Zo:Lo;case"bottom-right":return s?ei:Ao;case"down":return e?s?ti:Fo:s?si:Bo;case"left":return e?s?ni:Vo:s?ri:us;case"right":return e?s?ii:Ro:s?oi:Do;case"top-left":return s?li:Go;case"top-right":return s?ai:Ho;case"up":return e?s?di:Yo:s?ci:Wo;default:return s?Qo:zo}}const ze=e=>{const{big:s=!1,direction:t,reverse:r=!1,...n}=e,o=T.useMemo(()=>fi(s,r,t),[s,t,r]);return D(st,{keyframes:o,...n})};j`
  from {
