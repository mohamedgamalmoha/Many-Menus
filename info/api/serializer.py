...
from restaurant.constants import DEFAULT_HEADER_IMAGE_URL
from restaurant.api.mixins import DefaultImageSerializerMixin
from ..models import MainInfo, HeaderImage, Service, AboutUs, Theme, ContactUs
...
class HeaderImageSerializer(DefaultImageSerializerMixin, serializers.ModelSerializer):
    ...
    class Meta:
        model = HeaderImage
        exclude = ('info', 'create_at', 'update_at')
