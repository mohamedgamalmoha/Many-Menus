# Generated by Django 5.1.4 on 2025-01-25 22:48
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('info', '0008_alter_maininfo_image_alter_theme_image'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', django_resized.forms.ResizedImageField(crop=None, force_format='WEBP', keep_meta=True, null=True, quality=100, scale=None, size=[1920, 1080], upload_to='headers/', validators=[restaurant.validators.FileSizeValidator(max_upload_file_size=20971520)], verbose_name='Image')),
